-- HORORA V1 — hotfix: parse current_user() as a function under search_path=pg_catalog.
-- Canonical CREATE OR REPLACE of persist_horodateur_payroll_accountant_report.
-- Signature, grants, SECURITY INVOKER, and business rules unchanged.
