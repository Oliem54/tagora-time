...
-- Livraison des notifications liées à une alerte (journal technique).
-- alert_id peut être null pour tracer un échec sans alerte mère encore créée.
...
-- RLS : pas de politique grand public pour l’instant (accès via service role / API serveur).
