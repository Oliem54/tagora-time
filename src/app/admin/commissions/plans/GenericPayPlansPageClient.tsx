    ...
    <main className="page-container">
      ...
      <div className="ui-stack" style={{ marginTop: 20, gap: 20 }}>
        <SectionCard title="Organisation">
          <label className="ui-stack-xs" style={{ maxWidth: 420 }}>
        ...
        <SectionCard title="Nouveau plan">
          <form className="ui-stack" style={{ gap: 12, maxWidth: 520 }} onSubmit={createPlan}>
            ...
            <button type="submit" className="tagora-dark-action" disabled={saving || !organizationId}>
                  ...
                  >
                    <div className="ui-stack-xs">
                      ...
                      <span className="ui-text-muted">
                        {template.template_code} · {template.status} ·{" "}
                        {template.version_label} · {template.assignment_count}{" "}
                        affectation(s)
                      </span>
                    </div>
                    <Link
